...
In software development, the nightly-build version of a code is:

```
A version generated automatically every night from the latest code. Often unstable.
```

In Cheerfulism, here I save as a copy the current state of the next version I'm writing.
